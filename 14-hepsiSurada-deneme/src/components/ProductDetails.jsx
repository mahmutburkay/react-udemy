...
function ProductDetails() {
    ...
    const getProductById = () => {
        ...
        products && products.map((product) => {
            if (product.id == id) { // gelen id ile store daki eşitse setle
                ...
                <div>
                    ...
                    <div>
                        <button onClick={addBasket}
                            style={{ marginTop: '25px', border: 'none', padding: '10px', backgroundColor: 'rgb(185,76,76)', borderRadius: '5px', cursor: 'pointer', color: '#fff' }}>Sepete Ekle</button>
                    </div>
